...
public class ValueMetaBase implements IValueMeta {
  ...
  @JsonIgnore protected boolean isLargeObject = false;
  ...
  public Object convertDataFromString(
    ...
    if ( pol == null && isStringValue && EMPTY_STRING_AND_NULL_ARE_DIFFERENT ) {
    ...
    try {
      ...
      switch (getType()) {
        ...
        case IValueMeta.TYPE_STRING:
          ...
          break;
        case IValueMeta.TYPE_BINARY:
          if (isLargeObject && iDatabase.isSupportsGetBlob()) {
